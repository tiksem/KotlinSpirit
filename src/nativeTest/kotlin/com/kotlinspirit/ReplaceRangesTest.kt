...
class ReplaceRangesTest {
    @Test
    fun testEmpty() {
        assertEquals("Hello!".replaceRanges(emptyList(), "YO").toString(), "Hello!")
    }

    @Test
    fun testOneRangeMiddle() {
        assertEquals("Hello!".replaceRanges(list(1..4), "YO").toString(), "HYO!")
    }

    @Test
    fun testOneRangeEnd() {
        assertEquals("Hello!".replaceRanges(list(3..5), "YO").toString(), "HelYO")
    }

    @Test
    fun testMix1() {
        assertEquals("Hello Vasia, How are you today".replaceRanges(

...
class ReplaceTest {
    ...
    fun replaceAllIntegers() {
        ...
        assertEquals("Hello eee, How is your time eee.eee today eee", result)
    }
    ...
    fun replaceAllNameSplits() {
        ...
        assertEquals("eee 3344543, eee is your time eee 456.233 today 321", result)
    }
    ...
    fun replaceFirstNameSplit() {
        ...
        assertEquals("3344543, eee is your time No 456.233 today 321", result)
    }
    ...
    fun multiplyTwiceAllIntegers() {
        ...
        assertEquals("Hello 4 yoyoyo 90 norm -128", result.toString())
    }
    ...
    fun multiplyTwiceFirstInteger() {
        ...
        assertEquals("Hello 4 yoyoyo 45 norm -64", result.toString())
    }
